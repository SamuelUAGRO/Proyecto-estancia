...
public class Asistencia {
    ...
    public Asistencia(int id_asistencia, Date dia_asistencia, Timestamp hora_entrada, Timestamp hora_salida, Timestamp hora_actualizacion) {
    ...
    public Asistencia(Date dia_asistencia, Timestamp hora_entrada, Timestamp hora_salida, Timestamp hora_actualizacion) {
        this.dia_asistencia = dia_asistencia;
        this.hora_entrada = hora_entrada;
        this.hora_salida = hora_salida;
        this.hora_actualizacion = hora_actualizacion;
    ...
    public Date getDia_asistencia() {
        return dia_asistencia;
    }

    public void setDia_asistencia(Date dia_asistencia) {
        this.dia_asistencia = dia_asistencia;
    }
